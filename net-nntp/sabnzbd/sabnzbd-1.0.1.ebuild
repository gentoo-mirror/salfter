...
src_prepare() {
	epatch "${FILESDIR}"/1.0.0-use-system-configobj-and-feedparser.patch
	epatch "${FILESDIR}"/1.0.0-growler-support-gntp-1.0.patch
	epatch "${FILESDIR}"/1.0.0-disable_growl_by_default.patch
...
src_install() {
	...
	dodoc {ABOUT,ISSUES,README}.txt scripts/Sample-PostProc.sh licenses/*
