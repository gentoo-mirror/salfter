...
inherit eutils perl-module cmake-utils eapi7-ver

MY_PV=$(ver_rs 3 -)
S=${WORKDIR}/Slic3r-version_${MY_PV}
...
SRC_URI="https://github.com/prusa3d/Slic3r/archive/version_$MY_PV.tar.gz -> $P.tar.gz"
...
PATCHES=$FILESDIR/$P-no-locallib.patch

src_configure() {
  local mycmakeargs=( -DSLIC3R_WX_STABLE=1 )
