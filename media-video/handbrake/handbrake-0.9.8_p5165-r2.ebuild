...
SRC_URI="https://trac.handbrake.fr/changeset/5165/trunk?old_path=%2F&old=5165&format=zip -> ${MY_P}.zip
...
src_unpack() {
	unpack ${MY_P}.zip
	mv ${WORKDIR}/trunk ${WORKDIR}/${MY_P}
	find ${WORKDIR}/${MY_P} -type f -exec chmod +x \{} \;
}
