...
# $Header: /var/cvsroot/gentoo-x86/www-servers/apache/apache-2.2.29.ebuild,v 1.10 2015/02/24 10:57:05 ago Exp $
...
DEPEND="ssl? ( dev-util/indent dev-lang/perl )"
...
src_prepare() 
{
  ...
  epatch $FILESDIR/$P-logjam-mitigation.patch
  cd $WORKDIR/httpd-$PV/modules/ssl
